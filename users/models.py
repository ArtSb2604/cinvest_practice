...
class User(AbstractUser):
    ...
    social_contact = models.CharField(verbose_name='Контакт для оперативной связи (Телеграм, VK или что-то ещё)',max_length=100)
    ...
    what_tasks = models.CharField(verbose_name='Опишите, какими задачами вам было бы интересно заниматься во время стажировки',max_length=100)
